...
[ ] File: [file_path]
    ...
    - (other detected violation of this file following the conventions)
For compliant files use: 

- [x] File: [file_path]: All code adheres to coding standards`

- (other files that violate the standards following the conventions)
</violationsTemplate>
