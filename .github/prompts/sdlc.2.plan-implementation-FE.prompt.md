...
EXECUTE the following phases SEQUENTIALLY. COMPLETE each phase entirely before proceeding to the next:
    ...
    <phase number="4" name="Task Decomposition">
        <task id="4.1" title="Convert All Mockups to HTML">
        ...
        <task id="4.2" title="Task Definition">
        ...
        <task id="4.3" title="For UI Related Sub-Task">
        ...
        <task id="4.4" title="For Other Sub-Tasks">
        ...
        <task id="4.5" title="Task List Section Update">
...
AFTER COMPLETING all phases: EXECUTE these tasks:
    <task title="Execute Reflection Workflow">
        READ and FOLLOW  `.github/prompts/reflections/sdlc.2.plan-implementation-fe.reflection.md` workflow
    </task>
